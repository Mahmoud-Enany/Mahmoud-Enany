...
<p>
I'm a <strong>Full Stack Developer</strong> specialized in building scalable, 
production-ready web applications using <strong>ASP.NET Core</strong>, 
<strong>Angular</strong>, <strong>React</strong>, and <strong>SQL Server</strong>.
</p>
...
<a href="https://mahmoud-enany.github.io"><img
    src="https://img.shields.io/badge/-Portfolio-000000?style=flat&logo=github&logoColor=white" alt="Portfolio"></a>
</p>
...
|---|---|---|
| **LocalBrands** | Full e-commerce platform with Stripe payment & admin dashboard | ASP.NET Core · EF Core · SQL Server · Identity |
| **Quiz-Forge** | Automated exam system with advanced SQL Server architecture | SQL Server · Stored Procedures · Node.js · React |
| **ClinicEase** | Clinic management system — 3 roles, booking, medical records | ASP.NET Core · Angular · Docker · Stripe · JWT |
| **ADAS** | Night Vision & Traffic Sign Recognition automotive system | Python · YOLOv8 · Embedded Linux · OpenCV |
...
![YOLO](https://img.shields.io/badge/YOLOv8-FFCC00?style=flat&logo=python&logoColor=black)
...
![Embedded C](https://img.shields.io/badge/Embedded%20C-003366?style=flat&logo=c&logoColor=white)
